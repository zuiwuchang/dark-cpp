#ifndef _DARK_CPP__WINDOWS_STRING_UTF__HPP_
#define _DARK_CPP__WINDOWS_STRING_UTF__HPP_
...
namespace dark
{
	namespace windows
	{
		std::wstring char_to_wchar(const std::string& str)
		{
		...
		std::string wchar_to_char(const std::wstring& wcs)
		{
